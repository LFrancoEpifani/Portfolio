...
export default function DesktopProjects() {
  ...
  return (
    <div id='desktop-projects' className='text-center lg:text-start '>
       <h2 className='nunito text-center text-2xl font-semibold my-70 lg:text-start lg:mx-90'><span className=' border-b-4 border-black'>{t('projects')}</span></h2>
       ...
       />
           ...
           <div>
               <h3 className='nunito text-2xl my-10 font-bold lg:my-20'>Art Gallery Elena</h3>
               ...
               <div className='flex justify-center my-20 lg:justify-start lg:items-center gap-30 lg:mt-30 lg:mx-5'>
                   ...
                   <div className='flex gap-10'>
                       ...
                       <Icon className='text-3xl' icon="devicon:mongodb" />
                       <Icon className='text-3xl' icon="devicon:express" />
                       <Icon className='text-3xl' icon="devicon:nodejs" />
                   </div>
               </div>
               <div>
               <div className='flex justify-center items-center gap-8 my-20 lg:justify-start lg:items-center lg:my-50'>
                       <a href="https://github.com/LFrancoEpifani/ArtGalleryElena"  target='_blank'>
                           <Icon className='text-3xl' icon="mdi:github" />
                       </a>
                       <a href="https://artgalleryelena.vercel.app/"  target='_blank'>
