...
const resources = {
  ...
  es: {
    translation: {
      ...
      artgallery:"Sitio web e-commerce para la compra de arte, construido con React para una experiencia interactiva. Utiliza Node y Express para una infraestructura de servidor robusta, con MongoDB para gestión eficiente de datos. Ofrece una navegación fluida y un diseño responsive, facilitando la exploración y adquisición de obras artísticas.",
      aboutme: "SOBRE MÍ",
